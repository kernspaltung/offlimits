         ...
         <div class="row align-center">
            <div class="small-3 columns">
               <a href="https://www.facebook.com/offlimitsmx" target="_blank">
                  <i class="fa fa-facebook fontXL"></i>
               </a>
            </div>
            <div class="small-3 columns">
               <a href="https://twitter.com/OfflimitsMx" target="_blank">
                  <i class="fa fa-twitter fontXL"></i>
               </a>
            </div>
            <div class="small-3 columns">
               <a href="https://www.instagram.com/offlimitsmx" target="_blank">
                  <i class="fa fa-instagram fontXL"></i>
               </a>
            </div>
            <div class="small-3 columns">
